...
/**
 * Fill `buf` with U(-scale, scale) values using a deterministic LCG keyed by `seed`.
 * Matches original NNCP init_val = init_range / sqrt(d_model) = 1.0/16 = 0.0625.
 */
void nn_weights_init_uniform(float* buf, size_t n_elements,
